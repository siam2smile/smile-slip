          ...
          <div className="bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl flex flex-col max-h-[90vh] shadow-2xl">
            ...
            <div className="overflow-y-auto flex-1 px-5 py-4 text-xs text-slate-600 leading-relaxed space-y-4"
              ...
              <div>
                ...
                <p><strong>1. บริการ:</strong> Smile Slip Pro เป็นระบบ SaaS ครบวงจร (สแกนสลิปด้วย AI + POS + บัญชี + สต็อค + จัดส่ง + เงินเดือน) ไม่ใช่สถาบันการเงินหรือที่ปรึกษาบัญชี/ภาษีที่มีใบอนุญาต</p>
                ...
                <p className="mt-2"><strong>5. การระงับ/ลบบัญชี:</strong> สงวนสิทธิ์ระงับบัญชีที่ใช้งานผิดกฎหมายหรือผิดเงื่อนไขทันที — ท่านลบบัญชีเองได้ตลอดเวลา (เก็บข้อมูลไว้ 6 เดือนก่อนลบถาวร ดูรายละเอียดด้านล่าง)</p>
              </div>

              <div>
                <p className="font-black text-slate-800 text-sm mb-2 mt-4">นโยบายความเป็นส่วนตัว (PDPA) (สรุป)</p>
                <p><strong>1. บทบาทของเรา:</strong> ข้อมูลร้านค้า/บัญชีผู้ใช้ เราเป็นเจ้าของข้อมูล (Controller) — ข้อมูลธุรกรรม/สมาชิกร้านของท่าน เราเป็นแค่ผู้ให้บริการเก็บแทนร้าน (Processor) ไม่ใช่เจ้าของข้อมูล ไม่ขายต่อบุคคลที่สาม</p>
                <p className="mt-2"><strong>2. ข้อมูลที่เก็บ:</strong> ชื่อร้าน/LINE ID/อีเมล/เบอร์โทร/บัญชีธนาคาร/เครดิต และข้อมูลธุรกรรม (รูปสลิป/ยอดเงิน) — ชื่อผู้โอนเงินที่อ่านจากสลิปเป็นข้อมูลบุคคลภายนอก ใช้เท่าที่จำเป็นเพื่อกระทบยอดบัญชีของร้านเท่านั้น ไม่ใช้เพื่อการตลาด</p>
                ...
                <p className="mt-2"><strong>5. การเก็บรักษา/ลบข้อมูล:</strong> ลบบัญชีแล้วเก็บข้อมูลไว้ 6 เดือน (กู้คืนได้ถ้าสมัครใหม่ด้วยไลน์ไอดีเดิมภายในช่วงนี้) จากนั้นลบถาวรอัตโนมัติ</p>
                <p className="mt-2"><strong>6. สิทธิ์ของท่าน:</strong> ขอเข้าถึง แก้ไข ลบ หรือถอนความยินยอมได้ตลอดเวลา ติดต่อ DPO ได้ที่ smileslip.official@gmail.com</p>
              </div>
