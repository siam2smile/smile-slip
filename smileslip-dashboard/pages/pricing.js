...
export default function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        '🧾 รายงานภาษี VAT (ภ.พ.30) + Excel สำเร็จรูป',
        '💰 ระบบเงินเดือน + ประกันสังคม + ภาษีหัก ณ ที่จ่าย',
      ],
    ...
    },
    {
      ...
      features: [
        ...
        '👑 Customer 360 / วิเคราะห์กลุ่มลูกค้า RFM',
        '📈 วิเคราะห์เชิงกลยุทธ์ (ช่วงราคา/สินค้าคู่กัน/ชั่วโมงขายดี/AI สรุปยอด)',
        '📝 บันทึกประจำวันของพนักงาน',
        '🏷️ White-Label (ไม่มีชื่อ Smile Slip Pro บนเอกสาร)',
  ...
  const comparisonRows = [
    ...
    { label: '📊 รายงาน Excel สำเร็จรูป (VAT/สาขา/สต็อกหมุนเวียน)', values: [false, false, false, true, true] },
    { label: '💰 ระบบเงินเดือน + ประกันสังคม + ภาษีหัก ณ ที่จ่าย', values: [false, false, false, true, true] },
    { label: '👑 Customer 360 / วิเคราะห์กลุ่มลูกค้า RFM', values: [false, false, false, false, true] },
    { label: '📈 วิเคราะห์เชิงกลยุทธ์ (ช่วงราคา/สินค้าคู่กัน/ชั่วโมงขายดี/AI สรุปยอด)', values: [false, false, false, false, true] },
    { label: '📝 บันทึกประจำวันของพนักงาน', values: [false, false, false, false, true] },
    { label: '🏷️ White-Label (ไม่มีชื่อ Smile Slip Pro บนเอกสาร)', values: [false, false, false, false, true] },
    ...
    { label: '📊 รายงาน Excel Custom (ทีมงานจัดทำให้)', values: [false, false, false, false, true] },
  ];
