              ...
              <div className="space-y-2">
                ...
                <div className="text-slate-600 leading-relaxed text-sm md:text-base space-y-1">
                  <p><strong>ข้อมูลร้านค้า/สมาชิกร้าน/ธุรกรรมทางธุรกิจ:</strong> เก็บไว้ในฐานข้อมูลของเราตลอดระยะเวลาที่ร้านค้าใช้บริการ
                    ...
                    และสามารถลบร้านค้า/บัญชีของตนเองพร้อมข้อมูลที่เกี่ยวข้องทั้งหมดออกจากฐานข้อมูลของเรา<strong>ทันทีอย่างถาวร</strong>
                    ได้เองผ่านเมนูตั้งค่า (ต้องยืนยันตัวตนก่อนดำเนินการ)</p>
                  <p><strong>รูปสลิป/ใบเสร็จ:</strong> เก็บใน Google Drive ของท่านเอง ท่านเป็นผู้ควบคุมและลบได้โดยตรง</p>
                  <p><strong>ข้อมูล Pattern การใช้งานแบบ Anonymized (ดูข้อ 8):</strong> เก็บไว้ตลอดอายุบัญชีเพื่อแสดงแนวโน้มย้อนหลัง และลบทันทีเมื่อร้านค้าปิดบัญชี/ลบร้านผ่านระบบเช่นเดียวกับข้อมูลอื่น</p>
