...
อัปเดตล่าสุด: 2026-07-20 (แก้บั๊ก Gemini thinking-token truncation เพิ่มอีก 2 จุด + เพิ่มสวิตช์ `MARKET_PRICE_FEATURE_LIVE` ซ่อนฟีเจอร์ดัชนีราคาจากลูกค้าจนกว่าจะปรึกษาทนาย — ดูข้อ 31 ในหัวข้อ "เหตุการณ์และบั๊กที่แก้แล้ว", **ยังไม่ได้ deploy**)
...
| Dashboard | `https://smileslip-dashboard-832247688217.asia-southeast1.run.app` | `smileslip-dashboard-00264-d2b` |
