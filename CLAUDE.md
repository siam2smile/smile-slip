...
อัปเดตล่าสุด: 2026-07-21 (ทำ 7 ข้อจากไฟล์ฟีดแบ็ก + วิเคราะห์ 2 ไอเดียฟีเจอร์ใหม่: บันทึกด้วยมือต้องเลือกสาขา, วันที่ย้อนหลังในรับสินค้า/ขาย/รายจ่าย, ส่งพนักงานเก็บเงินเชื่อ/ของดึงยอดอัตโนมัติ, ประวัติหนี้โชว์รายการสินค้า+รวมขายเชื่อที่เคยตกหล่น, พนักงานจัดส่งรับเงินบางส่วนได้ (ค้างจ่ายบางส่วน — เจอบั๊กจริงที่ confirm_delivery ไม่เคยเพิ่มยอดค้างชำระเลย), ตั้งค่าที่อยู่/ชื่อแบรนด์แยกต่อสาขาสำหรับใบเสร็จ/ใบกำกับภาษี + แก้ชื่อสาขาสำนักงานใหญ่ไม่เคยแก้ได้, จัดกลุ่มแท็บ POS มือถือใหม่ (แท็บหลัก 4 + เมนู "เพิ่มเติม") — ดูข้อ 34 ในหัวข้อ "เหตุการณ์และบั๊กที่แก้แล้ว" — **commit/push แล้ว ยังไม่ได้ deploy ขึ้น production (รอผู้ใช้ยืนยัน)**)
