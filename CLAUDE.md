...
27. **ระบบ VAT ครบวงจร (คำนวณ VAT ขาย/ซื้อ, toggle ร้านจด VAT, ใบกำกับภาษี PDF ทางการ, รับสินค้า 3-state VAT, รายงาน VAT) + หน้า "รายจ่าย" ใหม่ + เชื่อมรายงาน/กราฟวิเคราะห์ — ทำต่อจากข้อ 26 ตามที่ผู้ใช้อนุมัติล่วงหน้าไว้ทั้งหมด ("ทำตามนั้นทั้งหมด"):**
    - **toggle "ร้านนี้จดทะเบียน VAT"** เพิ่ม `pos_configs.vat_registered` (ต้องรัน SQL ด้วยมือก่อน — ดู "ต้องทำด้วยมือ" ด้านล่าง, ระหว่างยังไม่รัน default `false` เงียบๆ ไม่พัง แบบเดียวกับ pattern `receipt_paper_size`) — เปิดแล้วใบเสร็จขายหน้าร้านปกติ (ไม่ใช่แค่ใบกำกับภาษีทางการ) จะแยกแสดงยอดก่อน VAT/VAT 7% ให้อัตโนมัติ
