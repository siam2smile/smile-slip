...
25. **ระบบสินค้าหมุนเวียนรอบใหญ่ (กลุ่ม A-D จากที่ผู้ใช้ขอสรุปก่อนเริ่มทำ + ข้อเสนอเพิ่มเติมของ Claude ที่ผู้ใช้อนุมัติทั้งหมด) — ทำทีเดียวหลายกลุ่ม ทดสอบยิงจริงทุกจุดก่อน commit:**
    ...
    - **ยังไม่ได้ทำ (กลุ่ม E — แยกไว้ทำต่อ เพราะแตะโค้ดบอท LINE คนละส่วน):** รับสินค้าอัตโนมัติผ่านรูปถ่ายใน LINE (OCR ใบส่งของ) → สร้างรายการรอยืนยัน → แอดมินกดยืนยัน/แก้ไขก่อนตัดเข้าสต็อคจริง ผูกกับสาขา/กลุ่ม LINE ต้นทางอัตโนมัติ
